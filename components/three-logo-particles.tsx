...
export default function ThreeLogoParticles() {
  ...
  return (
    <section id="demo" className="relative w-full h-screen flex flex-col items-center justify-center bg-black">
      <canvas
        ref={canvasRef}
        className="w-full h-full absolute top-0 left-0 touch-none"
        aria-label="Interactive particle effect with three custom logos"
      />
      <div className="absolute bottom-[100px] text-center z-10 px-4">
        <h2 className="font-mono text-gray-400 text-sm sm:text-base md:text-lg mb-2">Interactive Particle Logos</h2>
        <p className="text-gray-500 text-xs sm:text-sm">
          Move your cursor to scatter the particles
          <br />
          <span className="text-gray-600">Touch and drag on mobile devices</span>
        </p>
      </div>
    </section>
  )
